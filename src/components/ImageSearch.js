    ...
    <div className='max-w-sm rounded overflow-hidden my-10 mx-auto'>
      <form onSubmit={submitSearch} className="w-full max-w-sm">
        <div className="flex items-center border-b-2 border-teal-500 py-2">
            ...
            <button className="flex-shrink-0 bg-purple-500 hover:bg-purple-700 border-purple-500 hover:border-purple-700 text-sm border-4 text-white py-1 px-2 rounded focus:outline-none" type="submit">
                Search
            </button>
        </div>
      </form>
